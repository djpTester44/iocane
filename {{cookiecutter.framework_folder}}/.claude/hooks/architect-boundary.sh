...
if [[ "$FILE_PATH" == *.py ]]; then
    echo "BLOCKED: /io-architect is active. Python implementation files cannot be written during design phase. Complete design in /io-architect before writing implementation files." >&2
    exit 2
fi
