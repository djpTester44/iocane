---
description: Retroactively create a missing connectivity test file from its CT spec in
             plan.md. Resolves open [TEST] HIGH backlog entries that have no /io-execute path.
---
