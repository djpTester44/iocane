---
description: Reconcile documentation artifacts with current codebase state. No PLAN.md — syncs roadmap.md, README.md, and seams.md.
---
...
**If `plans/seams.md` does not exist:** Create it from `.agent/templates/seams.md`, then populate every implemented component that is also registered in the Interface Registry.
