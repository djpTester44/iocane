...
3. We must establish clear Checkpoints (Milestones) for development, but we must NOT create granular, tactical subtasks. Keep milestones high-level.
...
[One to two paragraphs explaining WHAT the system does and WHY it exists. This feeds the 'System Context' in the project-spec.]

## 2. Technical Constraints & Stack
[Explicitly list the environment and tools. io-init uses this for the Spec.]
...
[Describe how data moves through the system from start to finish. Use numbered steps. io-init will translate this into the Mermaid architecture graph.]
...
[Define the distinct logical blocks of the system. io-architect will use these to generate the .pyi Protocol files.]
...
* **Business Logic/Rules:** [Specific rules that must be enforced. io-architect will put these in the .pyi docstrings.]
...
## 6. Execution Milestones (Checkpoints)
[Logical phases of development. io-init will copy this exactly to generate PLAN.md. Keep it strictly high-level; no granular subtasks.]
* **CP1:** Repository Foundation & Configuration
* **CP2:** [First Core Component implementation]
* **CP3:** [Second Core Component implementation]
* **CP4:** Integration & E2E Testing