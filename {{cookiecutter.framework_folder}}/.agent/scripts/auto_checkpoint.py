...
Usage:
    uv run python .agent/scripts/auto_checkpoint.py [--dry-run]
"""
...
def main() -> int:
    ...
    backlog_path = os.path.join(repo_root, "plans/backlog.md")
    plan_path = os.path.join(repo_root, "plans/plan.md")
    ...
    backlog_lines = read_lines(backlog_path)
